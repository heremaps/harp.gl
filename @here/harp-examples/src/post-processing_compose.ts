...
export namespace HelloPostProcessingExample {
    ...
    const renderLoop = new RenderController();
    ...
    // Create MapViews
    const mapViewA = new MapView({ ...commonMapViewOptions, theme: "resources/berlin_base.json" });
    const mapViewB = new MapView({
        ...commonMapViewOptions,
    ...
    renderLoop.renderFunction = time => {
        ...
        mapViewA.renderIfNeeded(time);

        renderer.setRenderTarget(renderTargetB);
        mapViewB.renderIfNeeded(time);
