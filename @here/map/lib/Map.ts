...
export interface MapOptions extends MapCameraOptions {
    ...
    /**
     * Application id - authentication token used by `OMV` and 3d Landmark datasources.
     *
     * @default unspecified
     */
    appId?: string;
    ...
    /**
     * Application code - authentication token used by `OMV` and 3d Landmark datasources.
     *
     * @default unspecified
     */
    appCode?: string;
...
export class Map {
    ...
    constructor(element: string | HTMLElement, options?: MapOptions) {
        if (!options || options.appId === undefined || options.appCode === undefined) {
            throw new Error("harp4web.Map: appId and appCode must be specified in options");
        }
