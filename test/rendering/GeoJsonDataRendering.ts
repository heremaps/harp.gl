...
describe("MapView + OmvDataSource + GeoJsonDataProvider rendering test", function () {
    ...
    describe("Polygons", async function () {
        ...
        it("Polygons stroked with dashed lines", async function () {
            const polygon = turf.polygon([
                [
                    [0, -31.00678505596569, 0],
                    [1.0928396263071818, -31.05064618402207, 0],
                    [2.1771049188988627, -31.18186980257445, 0],
                    [3.2442360171258997, -31.39937843965751, 0],
                    [4.285701380664364, -31.701382292269834, 0],
                    [5.293010524284, -32.08538786322708, 0],
                    [6.257725428258027, -32.54820940811007, 0],
                    [7.171470816670308, -33.08598262190083, 0],
                    [8.025944020755787, -33.694179934362325, 0],
                    [8.812925779945544, -34.367626793910624, 0],
                    [9.524294067612914, -35.10051841253731, 0],
                    [10.15204384639651, -35.88643662855169, 0],
                    [10.688316536781713, -36.718366827535604, 0],
                    [11.125443885353661, -37.58871525164258, 0],
                    [11.45601178372101, -38.48932752777407, 0],
                    [11.67295031402989, -39.41150985637252, 0],
                    [11.769656724137235, -40.34605501603346, 0],
                    [11.740157933378669, -41.283276130728034, 0],
                    [11.579318223252812, -42.2130519667184, 0],
                    [11.283095584684702, -43.12488828857957, 0],
                    [10.848846347875224, -44.0080003721863, 0],
                    [10.275671844161025, -44.85142195436399, 0],
                    [9.564792796871643, -45.64414544922321, 0],
                    [8.719927220329168, -46.37529690989431, 0],
                    [7.7476368493883, -47.034346725693325, 0],
                    [6.65759745819139, -47.61135331318414, 0],
                    [5.4627426507069, -48.097232230296534, 0],
                    [4.1792320226510355, -48.48403771996089, 0],
                    [2.8262056762641805, -48.76523857316948, 0],
                    [1.4253087704114478, -48.93596658248854, 0],
                    [0, -48.993214944034285, 0],
                    [-1.4253087704114478, -48.93596658248854, 0],
                    [-2.8262056762641805, -48.76523857316948, 0],
                    [-4.1792320226510355, -48.48403771996089, 0],
                    [-5.4627426507069, -48.097232230296534, 0],
                    ...
                    [-7.7476368493883, -47.034346725693325, 0],
                    [-8.719927220329168, -46.37529690989431, 0],
                    [-9.564792796871643, -45.6441454492232, 0],
                    [-10.275671844161025, -44.851421954364, 0],
                    [-10.848846347875224, -44.0080003721863, 0],
                    [-11.283095584684702, -43.124888288579555, 0],
                    [-11.579318223252812, -42.2130519667184, 0],
                    [-11.740157933378669, -41.283276130728034, 0],
                    [-11.769656724137235, -40.34605501603346, 0],
                    [-11.67295031402989, -39.41150985637252, 0],
                    [-11.45601178372101, -38.48932752777408, 0],
                    [-11.125443885353661, -37.58871525164258, 0],
                    [-10.688316536781713, -36.718366827535604, 0],
                    [-10.15204384639651, -35.8864366285517, 0],
                    [-9.524294067612914, -35.10051841253731, 0],
                    [-8.812925779945544, -34.367626793910624, 0],
                    [-8.025944020755787, -33.69417993436233, 0],
                    [-7.171470816670308, -33.08598262190083, 0],
                    [-6.257725428258027, -32.54820940811007, 0],
                    [-5.293010524284, -32.08538786322708, 0],
                    [-4.285701380664364, -31.701382292269834, 0],
            ...
            await geoJsonTest.run({
                mochaTest: this,
                testImageName: "geojson-circle-stroked-dashed-line",
                dataProvider: geoJsonStore,
                theme,
                lookAt: {
                    zoomLevel: 3,
                ...
                beforeFinishCallback: mapView => {
                    mapView.addDataSource(new DebugTileDataSource(webMercatorTilingScheme));
                }
            });
        });
    });
