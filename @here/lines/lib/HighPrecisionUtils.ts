...
import { HighPrecisionLineMaterial, HighPrecisionPointMaterial } from "@here/materials";
import {
    BufferAttribute,
    BufferGeometry,
    Camera,
...
export namespace HighPrecisionUtils {
    ...
    export function createPoints(
        ...
        const hpPointsMaterial: HighPrecisionPointMaterial =
            materialParameters && (materialParameters as any).isHighPrecisionPointMaterial
                ? (materialParameters as HighPrecisionPointMaterial)
