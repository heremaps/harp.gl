...
import { ImageTexture } from "@here/datasource-protocol";
import { IconMaterial } from "@here/materials";
import { BoxBuffer, SceneSet } from "@here/text-renderer";
...
class PoiRenderBuffer {
    ...
    pickTextElements(
        ...
        for (const batch of this.batches) {
            ...
            batch.boxBuffer!.pickBoxes(screenPosition, pickCallback);
        }
    }
}
