...
import { StyleSetEvaluator } from "@here/harp-datasource-protocol/lib/StyleSetEvaluator";
import {
    GeoCoordinates,
    mercatorProjection,
    TileKey,
...
import { IPolygonGeometry } from "../lib/GeometryProcessor";
import { world2tile } from "../lib/Utils";
import { VectorTileDataEmitter } from "../lib/VectorTileDataEmitter";

class VectorTileDataEmitterTest extends VectorTileDataEmitter {
    splitJaggyLinesTest(
        lines: number[][],
...
describe("VectorTileDataEmitter", function() {
    function createTileEmitter(): {
        tileEmitter: VectorTileDataEmitterTest;
        ...
        const decodeInfo = new DecodeInfo("test", projection, tileKey, tileSizeOnScreen);
        ...
        const tileEmitter = new VectorTileDataEmitterTest(decodeInfo, styleSetEvaluator);
