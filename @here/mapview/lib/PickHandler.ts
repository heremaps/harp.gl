...
export class PickHandler {
    ...
    intersectMapObjects(x: number, y: number): PickResult[] {
        ...
        for (const intersect of intersects) {
            ...
            if (intersect.object.userData !== undefined) {
                ...
                this.addObjInfo(featureData, intersect);
    ...
    /**
     * It finds the object information stored in the featureData.objInfos using the faceID.
     * It add them to the object.userData field.
     *
     * @param featureData It contains, among the other properties, an array of objectInfos.
     * @param intersect The intersection object, that contains the faceId of the hitten face.
     */
    addObjInfo(featureData: TileFeatureData, intersect: THREE.Intersection) {
        if (
