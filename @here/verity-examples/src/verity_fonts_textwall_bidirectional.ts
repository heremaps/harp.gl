...
export namespace NewFontsExample {
    ...
    function addText(mapview: MapView) {
        ...
        const textG = new TextElement(
            "سد 9 أبريل 1947",
            [
                new THREE.Vector2(0, 0.6 * window.innerHeight * window.devicePixelRatio),
                new THREE.Vector2(
                    0.15 * window.innerWidth * window.devicePixelRatio,
                    0.725 * window.innerHeight * window.devicePixelRatio
                ),
                new THREE.Vector2(
                    0.35 * window.innerWidth * window.devicePixelRatio,
                    0.65 * window.innerHeight * window.devicePixelRatio
                ),
                new THREE.Vector2(
                    0.85 * window.innerWidth * window.devicePixelRatio,
                    0.775 * window.innerHeight * window.devicePixelRatio
                ),
                new THREE.Vector2(
        ...
        textArray.push(textA, textB, textC, textD, textE, textF, textG, textH);
