...
export function createMaterial(
    ...
    if (isShaderTechnique(technique)) {
        ...
        applyTechniqueStaticPropsToMaterial(technique, material, options.skipExtraProps);
    }
 ...
 */
export function getObjectConstructor(technique: TechniqueLike): ObjectConstructor | undefined {
