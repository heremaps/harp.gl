...
export class TextElement {
    ...
    /**
     * Optional style feature. If `true`, it will use a Bold font to render this `TextElement`.
     */
    isBold?: boolean;

    /**
     * Optional style feature. If `true`, it will render the glyphs in this `TextElement` slightly
     * slanted.
     */
    isOblique?: boolean;
    ...
    /**
     * If `true`, it will render text using a Bold font.
     * @default `undefined`
     */
    ...
    set bold(isBold: boolean | undefined) {
        this.isBold = isBold;
    }
     ...
     * @default `undefined`
     */
    get tracking(): number | undefined {
        return this.trackingFactor;
    }

    set tracking(trackingFactor: number | undefined) {
        this.trackingFactor = trackingFactor;
    }

    /**
     * If `true`, it will slightly slant the glyphs in this `TextElement`.
     * @default `undefined`
     */
    get oblique(): boolean | undefined {
        return this.isOblique;
    }

    set oblique(isOblique: boolean | undefined) {
