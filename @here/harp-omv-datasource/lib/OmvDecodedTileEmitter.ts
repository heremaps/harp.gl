...
export class OmvDecodedTileEmitter implements IOmvEmitter {
    ...
    processLineFeature(
        ...
        for (const technique of techniques) {
            ...
            if (
                ...
                const textTechnique = technique as TextTechnique;
                const text = ExtendedTileInfo.getFeatureText(env, textTechnique, this.m_languages);
    ...
    private applyPolygonTechnique(
        ...
        let floorHeight = env.evaluate<number>(extrudedPolygonTechnique.floorHeight);
        ...
        if (isExtrudedPolygonTechnique(technique)) {
            if (getOptionValue(technique.vertexColors, false)) {
                ...
                if (colorValue === undefined) {
                    colorValue = env.evaluate<number | string>(technique.defaultColor, 0x000000);
                }
