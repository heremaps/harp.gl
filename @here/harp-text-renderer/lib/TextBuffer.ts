...
export class TextBuffer extends BoxBuffer {
     ...
     */
    constructor(
        readonly textMaterial: THREE.MeshMaterialType | THREE.MeshMaterialType[],
        readonly outlineMaterial: THREE.MeshMaterialType | THREE.MeshMaterialType[],
        readonly renderOrder: number = 0,
     ...
     * @param mirrored If `true`, glyph will be mirrored (in the vertical axis).
     * @param oblique If `true`, glyph will be slightly slanted.
