...
export class MapRenderingManager implements IMapRenderingManager {
    ...
    private m_target1: THREE.WebGLRenderTarget = new THREE.WebGLRenderTarget(
        window.innerWidth,
        window.innerHeight
    );
    private m_target2: THREE.WebGLRenderTarget = new THREE.WebGLRenderTarget(
        window.innerWidth,
        window.innerHeight
    );
    ...
    render(
        ...
        let activeTarget: undefined | THREE.WebGLRenderTarget;
