...
import { ConcurrentDecoderFacade, MapView } from "@here/mapview";
...
`;
    ...
    const omvDataSource = new OmvDataSource({
        ...
        decoder: ConcurrentDecoderFacade.getTileDecoder("omv-tile-decoder-1")
    });
    ...
    if (SHOW_WEBTILES) {
        ...
        const omvDataSource2 = new OmvDataSource({
            ...
            apiFormat: APIFormat.HereV1,
            maxZoomLevel: 17,
            decoder: ConcurrentDecoderFacade.getTileDecoder("omv-tile-decoder-2"),
            authenticationCode: bearerTokenProvider
        });
