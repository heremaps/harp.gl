...
import { GenericFeatureModifier } from "../FeatureFilter";
import { FeatureFilterDescription, FilterDescription } from "../OmvDecoderDefs";

const logger = LoggerManager.instance.create("TomTomFeatureModifier");
 ...
 */
export class TomTomFeatureModifier extends GenericFeatureModifier {
