...
export namespace TextCanvasPickingExample {
    ...
    function animate() {
        ...
        if (assetsLoaded) {
            ...
            textCanvas.addText(textSample, textPosition, false, "black");

            textStyle.color!.setRGB(1, 0, 0);
            textPosition.set(window.innerWidth * 0.25, window.innerHeight * 0.25, 0.0);
            textCanvas.addText(textSample, textPosition, false, "red");

            textStyle.color!.setRGB(0, 1, 0);
            textPosition.set(-window.innerWidth * 0.25, -window.innerHeight * 0.25, 0.0);
            textCanvas.addText(textSample, textPosition, false, "green");

            textStyle.color!.setRGB(0, 0, 1);
            textPosition.set(window.innerWidth * 0.25, -window.innerHeight * 0.25, 0.0);
            textCanvas.addText(textSample, textPosition, false, "blue");
