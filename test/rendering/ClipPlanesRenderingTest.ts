...
const seaworld: FeatureCollection = {
    ...
    features: [
        ...
        // Crosshair at camera target [0,0] for high zoom levels.
        {
            type: "Feature",
            properties: { color: "red", minZoom: 6 },
            geometry: {
                type: "Polygon",
                coordinates: [
                    [
        ...
        // Crosshair at camera target [0,0] for low zoom levels.
        {
            type: "Feature",
            properties: { color: "red", maxZoom: 6 },
            geometry: {
                type: "Polygon",
                coordinates: [
                    [
