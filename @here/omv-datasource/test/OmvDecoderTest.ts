...
import { DecodedTile, getProjection, ThemeEvaluator } from "@here/datasource-protocol";
...
describe("OMVDecoder", () => {
    it(`decodes sample tile`, async () => {
        ...
        const themeEvaluator = new ThemeEvaluator(theme);
        // const decoderOptions: OmvDecoderOptions = {
        //     gatherFeatureIds: false
        // };
        let resultTile: DecodedTile | undefined;
        const decoder = new OmvDecoder(projection, themeEvaluator, false);
