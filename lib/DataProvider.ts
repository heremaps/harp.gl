...
/**
 * Abstract interface for all `DataProvider` subclasses. The `DataProvider` is an abstraction of the
 * tile loader which is only responsible for loading the binary data of a specific tile, without
 * any relation to displaying or even decoding the data.
 */
