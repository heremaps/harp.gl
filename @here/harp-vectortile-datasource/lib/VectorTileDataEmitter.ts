...
import { ILineGeometry, IPolygonGeometry } from "./GeometryProcessor";
...
const logger = LoggerManager.instance.create("VectorTileDataEmitter");
...
export class VectorTileDataEmitter {
            ...
            if (isLineTechnique(technique) || isSolidLineTechnique(technique)) {
                ...
                if (hasIndividualLineSegments) {
                    assert(
                        ...
                        "VectorTileDataEmitter#processLineFeature: " +
                ...
                logger.warn(
                    `VectorTileDataEmitter#processLineFeature: Invalid line technique
    ...
    processPolygonFeature(
        ...
        techniques.forEach(technique => {
            ...
            if (techniqueIndex === undefined) {
                throw new Error(
                    "VectorTileDataEmitter#processPolygonFeature: " +
    ...
    private applyLineTechnique(
        ...
        if (lineGroupGeometries === undefined) {
            ...
            if (lineGroupGeometries.objInfos && lineGroupGeometries.featureStarts) {
