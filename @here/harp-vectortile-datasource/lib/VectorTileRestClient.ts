...
const logger = LoggerManager.instance.create("VectorTileRestClient");
...
export interface VectorTileRestClientParameters {
    /**
...
/**
 * REST client supporting getting protobuf vector Tile from REST-based servers.
 */
export class VectorTileRestClient implements DataProvider {
    private readonly downloadManager: TransferManager;
    private readonly urlParams: { [key: string]: string };

    constructor(readonly params: VectorTileRestClientParameters) {
