...
export class ThemeBuilder {
    ...
    static readonly images = {
        ...
        "red-square": {
            url:
                "data:image/svg+xml;base64,",
            preload: true
        }
    };
