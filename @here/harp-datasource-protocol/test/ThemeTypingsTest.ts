...
describe.only("Theme typings test", function() {
    this.timeout(30000);

    it("syntax test for properly defined Theme object", async () => {
        this.timeout(30000);
    ...
    it("syntax test for improperly defined Theme object (excessive properties)", async () => {
        this.timeout(30000);
