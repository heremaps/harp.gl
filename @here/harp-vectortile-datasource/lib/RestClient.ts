...
const logger = LoggerManager.instance.create("RestClient");
...
export enum APIFormat {
     ...
     * Usage:
     *
     *     <RestClientParams.baseUrl>/<zoom>/<X>/<Y>/omv
     *
     * If [[RestClientParams.authenticationToken]] is provided, it will be added as HTTP header:
     *
     ...
     *
     * Usage:
     * `<RestClientParams.baseUrl>/<zoom>/<X>/<Y>.mvt?access_token=<RestClientParams.authenticationCode>`
     *
     * Format definition:
     ...
     *
     * Usage:
     * `<RestClientParams.baseUrl>/tiles/omsbase/256/<zoom>/<X>/<Y>.mvt?access_token=<RestClientParams.authenticationCode>`
     *
     * Format definition:
     ...
     *
     * Usage:
     * `<RestClientParams.baseUrl>/tiles/herebase.02/<zoom>/<X>/<Y>/omv?access_token=<RestClientParams.authenticationCode>`
     *
     * Format definition:
     ...
     *
     * Usage:
     * `<RestClientParams.baseUrl>/<zoom>/<X>/<Y>.pbf?key=<RestClientParams.authenticationCode>`
     *
     * Format definition:
     ...
     *
     * Usage:
     * `<RestClientParams.baseUrl>/hub/spaces/<space-id>/tile/web/<zoom>_<X>_<Y>.mvt?access_token=<RestClientParams.authenticationCode>`
     *
     * Format definition:
...
/**
 * Authentication token/code provider used by [[RestClient]] before each call to currently valid
